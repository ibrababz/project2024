...
#%% Load Start
    ...
    # wLoadDir = os.path.join(ROOT_DIR, 'project2024','test_09_resnet_ep_0-1200_lr_1e-03')
    # wLoadDir = os.path.join(ROOT_DIR, 'project2024','test_41_resnet_ep_0-2000_lr_1e-05')
    # wLoadDir = os.path.join(ROOT_DIR, 'project2024','test_10_resnet_ep_0-2000_lr_1e-05')
    # wLoadDir = os.path.join(ROOT_DIR, 'project2024','test_26_resnet_ep_0-1300_lr_1e-05')
    wLoadDir = os.path.join(ROOT_DIR, 'project2024','test_24_resnet_trainNew_ep_0-600_lr_1e-04')
    # wLoadDir = os.path.join(ROOT_DIR, 'project2024','quick_tester')
    wEvaluator.setLoadDir(wLoadDir)
    wEvaluator.loadFromCkpt('0339_min_val')
