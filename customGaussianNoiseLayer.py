...
@keras_export("keras.layers.GaussianNoiseCustom")
class GaussianNoiseCustom(layers.Layer):
    ...
    def __init__(self, stddev, seed=None, rate =0.5, **kwargs):
    ...
    def call(self, inputs, training=False):
        if training and self.stddev > 0 and tf.random.uniform([]) < self.rate:
