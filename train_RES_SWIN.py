...
#%%
    ...
    model.layers[-1].summary()
    load_folder ="resnet_t3000_v900_full_gradUnFrz_test2_ep_(400, 800)_lr_1e-05" 
    #load_folder = "resnet_t3000_v900_light_ep_(0, 400)_lr_1e-04"
    load_dir = os.path.join(os.getcwd(), load_folder)
    model.load_weights(os.path.join(load_dir,"model_epoch_0799_last_5_2.4008906_Unfrz_-176.hdf5" ))
...
#%%
    ...
    model_name = 'resnet_t3000_v900_back_test3'
    batch_size = 8
    epochs = (800,1200)

    lr = 0.000001 #WHEN FINE-TUNING, LOWER LEARNING RATE FROM 0.001 to  0.0001
...
#%%
    ...
    unfreezeFlag = 0 #1
#%%
    train_loss_tracker, test_loss_tracker = TrainAndTestV2(wDataObjectList, wValidDataObjectList, model, modelFlag, opt, batch_size, image_processor, epochs, save_dir, unfreezeFlag)
