...
#%%
    ...
    model.layers[-1].summary()
    load_folder ="resnet_t3000_v900_fullcycle_8bit_224_224_sample_4_test1_ep_(0, 1210)_lr_1e-04" 
    #load_folder = "resnet_t3000_v900_light_ep_(0, 400)_lr_1e-04"
    load_dir = os.path.join(os.getcwd(), load_folder)
    model.load_weights(os.path.join(load_dir,"model_epoch_1209_list_2.1412423_Unfrz_-176.hdf5" ))
...
#%%
    ...
    model_name = 'resnet_finetune_real_sample4_test1_8bit'
    batch_size = 8
    epochs = (0,600)
